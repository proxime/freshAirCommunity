        ...
        <>
            {headNews.length > 2 && (
                <div className="head-news-container-pc">
                    <Link to={`/news/${headNews[0]._id}`} className="head-news-main">
                    ...
                    <div className="head-news-secondary-container">
                        <Link to={`/news/${headNews[1]._id}`} className="head-news-secondary">
                        ...
                        <Link to={`/news/${headNews[2]._id}`} className="head-news-secondary">
                            <div className="head-news-secondary-image-container">
